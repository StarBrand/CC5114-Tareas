...
if __name__ == '__main__':
    ...
    ast = EquationGuesser(EXPECTED, VALUES, float, PROB_TERMINAL, DEPTH, MUTATION_RATE)
    environment = GAEngine(ast)
    result = environment.run_to_reach(0, ACCEPTABLE, POPULATION_SIZE, log=True, values=FOR_EVALUATE)

    _, ax = plt.subplots(figsize=(12, 12))

    ax.set_title("Symbolic Regression", fontsize=25)
    ...
    plt.savefig("../results/symbolic_regression.png")
